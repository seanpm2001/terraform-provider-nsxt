...
type TagsClient interface {
	...
	Create(orgIdParam string, projectIdParam string, vpcIdParam string, virtualMachineIdParam string, virtualMachineTagsUpdateParam nsx_policyModel.VirtualMachineTagsUpdate, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) error
}
...
func NewTagsClient(connector vapiProtocolClient_.Connector) *tagsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.virtual_machines.tags")
...
func (tIface *tagsClient) Create(orgIdParam string, projectIdParam string, vpcIdParam string, virtualMachineIdParam string, virtualMachineTagsUpdateParam nsx_policyModel.VirtualMachineTagsUpdate, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) error {
	...
	methodResult := tIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.virtual_machines.tags", "create", inputDataValue, executionContext)
