...
type VifsClient interface {
	...
	List(orgIdParam string, projectIdParam string, vpcIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.VirtualNetworkInterfaceListResult, error)
}
...
func NewVifsClient(connector vapiProtocolClient_.Connector) *vifsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.groups.members.vifs")
...
func (vIface *vifsClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, groupIdParam string, cursorParam *string, enforcementPointPathParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.VirtualNetworkInterfaceListResult, error) {
	...
	methodResult := vIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.groups.members.vifs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.VirtualNetworkInterfaceListResult
