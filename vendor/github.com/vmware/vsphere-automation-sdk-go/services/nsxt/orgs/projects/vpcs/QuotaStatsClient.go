...
type QuotaStatsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, pathPrefixParam string, constraintPathParam *string) (nsx_policyModel.QuotaStatsListResult, error)
}
...
func NewQuotaStatsClient(connector vapiProtocolClient_.Connector) *quotaStatsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.quota_stats")
...
func (qIface *quotaStatsClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, pathPrefixParam string, constraintPathParam *string) (nsx_policyModel.QuotaStatsListResult, error) {
