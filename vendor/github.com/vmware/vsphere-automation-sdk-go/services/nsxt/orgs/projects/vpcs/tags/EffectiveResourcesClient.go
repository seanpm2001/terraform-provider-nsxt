...
func NewEffectiveResourcesClient(connector vapiProtocolClient_.Connector) *effectiveResourcesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.tags.effective_resources")
...
func (eIface *effectiveResourcesClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, enforcementPointPathParam *string, filterTextParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string, tagParam *string) (nsx_policyModel.PolicyResourceReferenceListResult, error) {
	...
	methodResult := eIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.tags.effective_resources", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.PolicyResourceReferenceListResult
