...
type StatisticsClient interface {
	...
	List(orgIdParam string, projectIdParam string, vpcIdParam string, securityPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error)
}
...
func NewStatisticsClient(connector vapiProtocolClient_.Connector) *statisticsClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.security_policies.statistics")
...
func (sIface *statisticsClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, securityPolicyIdParam string, containerClusterPathParam *string, enforcementPointPathParam *string) (nsx_policyModel.SecurityPolicyStatisticsListResult, error) {
	...
	if inputError != nil {
		var emptyOutput nsx_policyModel.SecurityPolicyStatisticsListResult
		return emptyOutput, vapiBindings_.VAPIerrorsToError(inputError)
	}

	methodResult := sIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.security_policies.statistics", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.SecurityPolicyStatisticsListResult
	if methodResult.IsSuccess() {
		...
		return output.(nsx_policyModel.SecurityPolicyStatisticsListResult), nil
	} else {
