...
type StatsClient interface {
	...
	Get(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string) (nsx_policyModel.DhcpServerStatistics, error)
}
...
func (sIface *statsClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string) (nsx_policyModel.DhcpServerStatistics, error) {
