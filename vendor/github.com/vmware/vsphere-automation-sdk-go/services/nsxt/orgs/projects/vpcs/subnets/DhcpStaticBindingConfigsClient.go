...
func (dIface *dhcpStaticBindingConfigsClient) Delete(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string, bindingIdParam string) error {
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_static_binding_configs", "delete", inputDataValue, executionContext)
...
func (dIface *dhcpStaticBindingConfigsClient) Get(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string, bindingIdParam string) (*vapiData_.StructValue, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_static_binding_configs", "get", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
...
func (dIface *dhcpStaticBindingConfigsClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string, cursorParam *string, includeMarkForDeleteObjectsParam *bool, includedFieldsParam *string, pageSizeParam *int64, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.DhcpStaticBindingConfigListResult, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_static_binding_configs", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.DhcpStaticBindingConfigListResult
	if methodResult.IsSuccess() {
...
func (dIface *dhcpStaticBindingConfigsClient) Patch(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string, bindingIdParam string, dhcpStaticBindingConfigParam *vapiData_.StructValue) error {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_static_binding_configs", "patch", inputDataValue, executionContext)
	if methodResult.IsSuccess() {
		return nil
	} else {
		methodError, errorInError := typeConverter.ConvertToGolang(methodResult.Error(), dIface.GetErrorBindingType(methodResult.Error().Name()))
...
func (dIface *dhcpStaticBindingConfigsClient) Update(orgIdParam string, projectIdParam string, vpcIdParam string, subnetIdParam string, bindingIdParam string, dhcpStaticBindingConfigParam *vapiData_.StructValue) (*vapiData_.StructValue, error) {
	typeConverter := dIface.connector.TypeConverter()
	executionContext := dIface.connector.NewExecutionContext()
	...
	methodResult := dIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.subnets.dhcp_static_binding_configs", "update", inputDataValue, executionContext)
	var emptyOutput *vapiData_.StructValue
	if methodResult.IsSuccess() {
