...
type RolesClient interface {
	...
	List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RoleListResult, error)
}
...
func NewRolesClient(connector vapiProtocolClient_.Connector) *rolesClient {
	interfaceIdentifier := vapiCore_.NewInterfaceIdentifier("com.vmware.nsx_policy.orgs.projects.vpcs.aaa.roles")
...
func (rIface *rolesClient) List(orgIdParam string, projectIdParam string, vpcIdParam string, cursorParam *string, includedFieldsParam *string, pageSizeParam *int64, scopeParam *string, sortAscendingParam *bool, sortByParam *string) (nsx_policyModel.RoleListResult, error) {
	...
	methodResult := rIface.connector.GetApiProvider().Invoke("com.vmware.nsx_policy.orgs.projects.vpcs.aaa.roles", "list", inputDataValue, executionContext)
	var emptyOutput nsx_policyModel.RoleListResult
